    ...
    if hasattr(model, 'model'):
        for name, param in model.model.named_parameters():
            if 'attn_bias' in name:
                param.data = to_device(param.data, device)
...
if __name__ == "__main__":
    ...
    # model_path="/home/buhaoran2023/LLM_Models/Meta/Llama2/Llama-2-7b-hf"
    model_path="/home/buhaoran2023/LLM_Models/Meta/Llama3/Meta-Llama-3-8B"
    method="KGE"
